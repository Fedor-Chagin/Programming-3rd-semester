...
```
Пока что не найдена, временная от Deepseek:
                    ┌─────────────────────────────────────┐
                    │         PaymentProcessor            │
                    │            (Context)                │
                    ├─────────────────────────────────────┤
...
| Элемент UML | Значение |
|-------------|----------|
| `─────◀` (незакрашенный треугольник) | Наследование / реализация интерфейса |
| `- - -◀` (пунктир + треугольник) | Реализация интерфейса |
| `◇────▶` (незакрашенный ромб) | Агрегация (контекст содержит ссылку на стратегию) |
...
Пока что не найдена, временная от Deepseek:
                    ...
                    │            (Context)                │
                    ├─────────────────────────────────────┤
                    │ - handlers: dict<int, EventHandler> │
                    ├─────────────────────────────────────┤
...
| Код открыт для расширения, закрыт для изменения | Код может дублироваться |
